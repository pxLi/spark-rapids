...
then
    ...
    export PYSP_TEST_spark_driver_extraJavaOptions="-ea -Duser.timezone=UTC -Dio.netty.tryReflectionSetAccessible=true $COVERAGE_SUBMIT_FLAGS"
    export PYSP_TEST_spark_executor_extraJavaOptions='-ea -Duser.timezone=UTC -Dio.netty.tryReflectionSetAccessible=true'
