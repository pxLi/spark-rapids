...
```shell 
spark-shell --jars rapids-4-spark-tests_2.12-21.08.0xxx-tests.jar,rapids-4-spark-udf-examples_2.12-21.08.0.jar,rapids-4-spark-integration-tests_2.12-21.08.0-tests.jar,scalatest_2.12-3.0.5.jar,scalactic_2.12-3.0.5.jar
```
...
```
$SPARK_HOME/bin/spark-submit --jars "rapids-4-spark_2.12-21.08.0xxw.jar,rapids-4-spark-udf-examples_2.12-21.08.0xxw.jar,cudf-21.08.2x-cuda11.jar" ./runtests.py
```
